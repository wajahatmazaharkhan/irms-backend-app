  ...
  const schema = Joi.object({
    ...
    department: Joi.string()
      ...
      .messages({
        ...
        "any.only":
          "Department must be one of [development, hr, research, communication]", // Custom message for invalid department
      }),
    ...
    mnumber: Joi.string()
      ...
      .messages({
        ...
        "string.pattern.base":
          "Mobile number must be a valid 10-digit number starting with 3, 6, 7, 8, or 9, with an optional country code",
    ...
    startDate: Joi.custom((value, helpers) => {
      ...
      .messages({
        "date.base":
          "Start date must be a valid date in YYYY-MM-DD or DD-MM-YYYY format",
      }),
    ...
    EndDate: Joi.custom((value, helpers) => {
      ...
      "date.base":
        "End date must be a valid date in YYYY-MM-DD or DD-MM-YYYY format and after the start date.",
    }),
